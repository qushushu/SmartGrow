    ...
    <div>
        ...
        <div v-show="mode=='table'">
            <el-table ref="multipleTable" :data="paramTable" border stripe size="small"tooltip-effect="dark" empty-text="暂无数据">
                ...
                <el-table-column prop="MI_SCH" :label="$t('message.母液方案')"> </el-table-column>
                <el-table-column prop="MI_NUM" :label="$t('message.母液数量')"> </el-table-column>
                ...
                <el-table-column prop="SI_L_RUN" :label="$t('message.左喷灌泵')"> 
                    <template slot-scope="scope">
                ...
                <el-table-column prop="SI_R_RUN" :label="$t('message.右喷灌泵')"> 
                    <template slot-scope="scope">
